  ...
  if (!currentUser) {
    return (
      <div className="min-h-screen bg-[#f8fafc] text-slate-800 flex flex-col justify-between font-sans">
        ...
        <div className="bg-[#0f172a] px-4 py-2.5 text-xs text-slate-300 border-b border-slate-800">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
            ...
            <a
              href="#aujoten"
              className="inline-flex items-center gap-1.5 bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/40 px-3 py-0.5 rounded-full text-[11px] font-bold font-mono transition-all"
            >
              <span>Aujoten Nig. Ltd Portal</span>
